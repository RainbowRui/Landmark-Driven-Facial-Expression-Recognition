...
class ResNet(nn.Module):
    def __init__(self, landmark_num, block, num_blocks, num_classes=7):
        ...
        torch.nn.init.kaiming_normal_(self.classifier.weight.data)
        ...
        torch.nn.init.kaiming_normal_(self.landmark_layer.weight.data)
        torch.nn.init.zeros_(self.landmark_layer.bias.data)
...
def ResNet18(landmark_num):
    return ResNet(landmark_num, BasicBlock, [2,2,2,2])